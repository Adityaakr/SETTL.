...
export function generateInvoicePDF(data: InvoicePDFData) {
  ...
  doc.setFont('helvetica', 'bold')
  doc.setTextColor(darkGray[0], darkGray[1], darkGray[2])
  // Extract number from invoiceNumber (handle both "INV-0000000004" and "0000000004" formats)
  ...
  doc.text(invoiceNum, leftStart + 25, yPos)
  ...
  // Generate filename (invoiceNum already defined above)
