...
export function generateInvoicePDF(data: InvoicePDFData) {
  ...
  doc.setFont('helvetica', 'bold')
  doc.setTextColor(COLORS.text[0], COLORS.text[1], COLORS.text[2])
  doc.text('SETTL. Protocol', iconX, yPos + 20)
  ...
  if (data.tokenId && data.nftAddress) {
    ...
    doc.text('Tokenized Bill Powered by SETTL.', leftStart + 15, yPos + 18)
  ...
  doc.setFont('helvetica', 'bold')
  doc.setTextColor(COLORS.text[0], COLORS.text[1], COLORS.text[2])
  doc.text('SETTL. Network', leftStart + 15, yPos + 30)
  ...
  doc.setFont('helvetica', 'normal')
  doc.setTextColor(COLORS.mutedText[0], COLORS.mutedText[1], COLORS.mutedText[2])
  doc.text('Generated by SETTL. - Powered by blockchain | Tokenized as ERC721 NFT on Mantle Network', margin, footerY - 10)
