...
contract AdvanceEngine is IAdvanceEngine, AccessControl {
     ...
     * @param ltvBps Loan-to-value in basis points (e.g., 8500 = 85% for Tier A, 5500 = 55% for Tier B, 2500 = 25% for Tier C)
     * @param aprBps APR in basis points (e.g., 1000 = 10%)
     * @return advanceAmount Amount sent to seller
     * @dev Frontend enforces tier-based LTV limits: Tier A = 85%, Tier B = 55%, Tier C = 25%
     */
